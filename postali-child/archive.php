...
<div class="columns blog-header">
	<div class="column-half">
        ...
        ?>
		<p id="breadcrumbs"><span><span><a href="/">Home</a> <span class="icon-drw-chevron-right"></span> <a href="/case-reults/">Case Results</a> <span class="icon-drw-chevron-right"></span> <?php echo get_the_category( $id )[0]->name ?> </span></span></span></p>
	</div>
	<div class="column-half">
	<span class="category-title">Category &nbsp; </span><div class="select-wrapper"> 
		...
		echo '<option value="/legal-blog/result_topic/' . $term->slug . '">' . $term->name . '</option>'; // ID of the category as an option value
		endforeach;
		echo '</select>';
	endif;
	?>
