 ...
 */
	...
	function postali_child() {
		...
		wp_enqueue_style( 'icon-styles', 'https://d1azc1qln24ryf.cloudfront.net/152819/BernardBrody/style-cf.css?huejvh' ); // Enqueue styles for svg icons
		wp_enqueue_style( 'adobe-fonts', 'https://use.typekit.net/mrx1exn.css' ); // Enqueue styles for adobe font families
	...
	function postali_child_register_nav_menus() {
		register_nav_menus(
			array(
				...
				'header-more-nav' => __( 'Additional Header Navigation', 'postali' ),
				'case-preparation' => __( 'Case Preparation Navigation', 'postali' ),
	...
	// set custom query amount for archive pages
